        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input class="form-control @error('position') is-invalid @enderror" type="text"
                           wire:model="position" id="position" required>
                </div>
            ...
            @if ( $tool_name !== 'custom_tool_link')
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input class="form-control @error('slug') is-invalid @enderror" type="text" wire:model="slug"
                               id="edit_slug" required>
                        <button type="button" class="btn bg-gradient-info mb-0"
                                wire:click="createSlug">{{ __('Create slug') }}</button>
                    </div>
            ...
            @if ( $tool_name == 'custom_tool_link')
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input class="form-control @error('custom_tool_link') is-invalid @enderror" type="text"
                               wire:model="custom_tool_link" id="edit_custom_tool_link" required>
                    </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-btn">
                        <a id="edit_icon_image" data-input="icon_edit"
                           class="btn bg-gradient-success featured-image rounded-0 rounded-start mb-0">
                ...
                <small
                    class="form-hint">{{ __('This icon will appear before the tool\'s name on the homepage.') }}</small>
            </div>
            ...
            @if ( $tool_name !== 'custom_tool_link')
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-btn">
                            <a id="edit_featured_image" data-input="thumbnail_edit"
                               class="btn bg-gradient-success featured-image rounded-0 rounded-start mb-0">
                                <i class="fa fa-picture-o"></i> {{ __('Choose') }}
                            </a>
                        </span>
