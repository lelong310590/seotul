...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}"
      dir="{{ ( Cookie::get('dir_mode') ) ? Cookie::get('dir_mode') : 'ltr' }}">
<head>
    <meta charset="utf-8">
...
<div class="wrapper">
    ...
    <div class="main-content position-relative border-radius-lg ps">
        ...
        <!-- Begin::Navbar -->
        <nav
            class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl px-0 mx-4 shadow-none border-radius-xl"
