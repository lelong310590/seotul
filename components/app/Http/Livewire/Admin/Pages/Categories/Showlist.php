...
class Showlist extends Component
{
    ...
    {
        $this->reset(['title', 'description', 'align', 'background', 'cateID', 'slug']);
    }

    public function createSlug()
    {
        $this->slug = SlugService::createSlug(PageCategory::class, 'slug', $this->slug);
    }
    ...
    public function addNewCategory()
    {
        try {
            ...
            if ($this->cateID != null) {
                ...
                $cate->slug = Security::clean(strip_tags($this->slug));
    ...
    public function editCategory($id)
    {
        try {
            ...
            $this->slug = Security::clean(strip_tags($cate->slug));
